...
def main():
    ...
    with st.sidebar:
        openai.api_key = st.text_input(label="OPENAI API Key", placeholder="Enter Your API Key", value="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", type="password")
